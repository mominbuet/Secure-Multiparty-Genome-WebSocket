...
//            System.out.println("Input Decrypted " + new Paillier(true).Decryption(new BigInteger(args[0])));
            System.out.println("INput " + new BigInteger(args[1]));
            inputA = gen.inputOfAlice(Utils.fromBigInteger(new BigInteger(args[1]), 1024));
...
//            System.out.println("GEN1 " + Utils.toBigInteger(gen.outputToAlice(scResult)));
        ...
        @Override
        public String prepareStringOutput(CompEnv<T> gen) throws Exception {
            BigInteger ret = new Paillier(true).Decryption(Utils.toBigInteger(gen.outputToAlice(scResult)));
            System.out.println("Gen result " + ret);
    ...
    public static class Evaluator<T> extends EvaRunnable<T> {
        ...
        public void prepareInput(CompEnv<T> gen) {
            ...
            gen.flush();
            boolean[] in = Utils.fromBigInteger(new BigInteger(args[1]), 1024);
